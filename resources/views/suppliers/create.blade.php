...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-lg shadow">
        <div class="p-6 border-b border-gray-200">
            ...
            <p class="text-sm text-gray-500 mt-1">Add a medicine supplier</p>
        </div>
        ...
        <form action="{{ route('suppliers.store') }}" method="POST" class="p-6 space-y-4">
            ...
            <div>
                ...
                <textarea name="address" rows="3" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500">{{ old('address') }}</textarea>
            </div>

            <div class="flex items-center gap-3 pt-2">
                <button type="submit" class="bg-emerald-600 hover:bg-emerald-700 text-white px-6 py-2 rounded-lg text-sm font-medium">Save Supplier</button>
